<?php 
	...
	if(isset($_POST) && !empty($_POST)){
		...
		$sql = "INSERT INTO sensorslist (sname, sintallationdate, dept_id) VALUES ( '".$sname."', '".$sintallationdate."', ".$dept_id.")";
		
		if ($conn->query($sql) === TRUE) {
		  $msg = "Sensor record created successfully";
		} else {
      ...
      <form action="" method="post">
        ...
        <div class="colums">
          ...
          <div class="item">
            ...
            <input id="sintallationdate" type="date" name="sintallationdate" required/>
          </div>
          <div class="item">
